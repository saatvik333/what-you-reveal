...
export async function detectPrivacyMode() {
    ...
    const result = {
        ...
        'ServiceWorker': swResult.supported ? (swResult.error ? 'Limited' : 'Available') : 'Not Supported',
        'FileSystem API': fsResult.supported ? (fsResult.available ? 'Available' : 'Blocked') : 'Not Supported',
