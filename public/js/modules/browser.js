...
export function collectBrowserData() {
    ...
    browserData['pdfViewerEnabled'] = nav.pdfViewerEnabled !== undefined ? (nav.pdfViewerEnabled ? 'Yes' : 'No') : 'Unknown';
    
    // WebDriver (automation detection)
    browserData['webdriver'] = nav.webdriver ? { value: 'TRUE (Automation Detected)', warning: true } : 'False';
