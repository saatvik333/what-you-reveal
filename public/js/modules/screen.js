...
export function collectScreenData() {
    ...
    if ('isExtended' in screen) {
        screenData['Multi-Monitor'] = screen.isExtended ? { value: 'Yes (Extended Display)', warning: true } : 'No';
    }
    ...
    // Touch Support
    screenData['Touch Support'] = ('ontouchstart' in window) || (navigator.maxTouchPoints > 0) ? 'Yes' : 'No';
