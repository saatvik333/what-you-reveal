...
const FONT_LIST = [
    ...
    'Microsoft Yi Baiti', 'MingLiU-ExtB', 'Mongolian Baiti', 'MS Gothic', 'MS PGothic',
    ...
    // macOS System Fonts
    'SF Pro', 'SF Pro Display', 'SF Pro Text', 'SF Compact', 'SF Mono',
    'New York', 'Helvetica', 'Helvetica Neue', 'Apple Color Emoji', 'Apple SD Gothic Neo',
    'Apple Symbols', 'Avenir', 'Avenir Next', 'Avenir Next Condensed', 'Baskerville',
    'Big Caslon', 'Bodoni 72', 'Charter', 'Cochin', 'Copperplate', 'DIN Alternate',
    'DIN Condensed', 'Futura', 'Geneva', 'Gill Sans', 'Hoefler Text', 'Lucida Grande',
    'Marker Felt', 'Menlo', 'Monaco', 'Noteworthy', 'Optima', 'Palatino', 'Papyrus',
    'Phosphate', 'Rockwell', 'Savoye LET', 'SignPainter', 'Skia', 'Snell Roundhand',
    'STHeiti', 'Superclarendon', 'Thonburi', 'Trattatello', 'Zapfino',
    'PingFang SC', 'PingFang TC', 'PingFang HK', 'Hiragino Sans', 'Hiragino Kaku Gothic ProN',
    
    // Linux System Fonts
    'Ubuntu', 'Ubuntu Mono', 'Ubuntu Condensed', 'Cantarell', 'DejaVu Sans',
    'DejaVu Sans Mono', 'DejaVu Serif', 'Liberation Sans', 'Liberation Serif',
    'Liberation Mono', 'Noto Sans', 'Noto Serif', 'Noto Mono', 'Noto Color Emoji',
    'Droid Sans', 'Droid Sans Mono', 'Droid Serif', 'Roboto', 'Roboto Mono',
    'Roboto Condensed', 'Roboto Slab', 'FreeSans', 'FreeSerif', 'FreeMono',
    'Nimbus Sans', 'Nimbus Roman', 'Nimbus Mono', 'URW Gothic', 'URW Bookman',
    
    // Common Web/Developer Fonts
    'Open Sans', 'Lato', 'Montserrat', 'Source Sans Pro', 'Source Code Pro',
    'Fira Code', 'Fira Sans', 'Fira Mono', 'JetBrains Mono', 'Cascadia Code',
    'IBM Plex Sans', 'IBM Plex Mono', 'Inter', 'Nunito', 'Poppins', 'Raleway',
    'Work Sans', 'PT Sans', 'PT Serif', 'PT Mono', 'Oxygen', 'Overpass',
    
    // CJK Fonts (Chinese, Japanese, Korean)
    'Noto Sans CJK SC', 'Noto Sans CJK TC', 'Noto Sans CJK JP', 'Noto Sans CJK KR',
    'Noto Serif CJK', 'Source Han Sans', 'Source Han Serif', 'WenQuanYi Micro Hei',
    'WenQuanYi Zen Hei', 'AR PL UMing', 'Meiryo', 'Meiryo UI', 'Yu Mincho',
    'HGGothicE', 'HGMaruGothicMPRO', 'Malgun Gothic Semilight', 'Batang', 'Dotum',
    'Gulim', 'NanumGothic', 'NanumMyeongjo',
    
    // Arabic/Hebrew/Indic Fonts
    'Noto Sans Arabic', 'Noto Sans Hebrew', 'Noto Sans Devanagari', 'Noto Sans Tamil',
    'Tahoma', 'Scheherazade', 'Amiri', 'Lateef', 'David', 'Miriam', 'Lohit Devanagari',
    'Lohit Tamil', 'Mangal', 'Aparajita', 'Kokila', 'Utsaah'
];
...
export async function collectFontData() {
    ...
    return {
        ...
        'Installed Fonts': detected.length > 0 
            ? detected.join(', ') 
            : 'None detected (Fingerprinting protection?)'
    };
}
...
function categorizeFont(font, categories) {
    ...
    const macFonts = ['SF ', 'Helvetica', 'Menlo', 'Monaco', 'Apple', 'PingFang', 'Hiragino', 'Lucida Grande'];
    ...
    const webFonts = ['Open Sans', 'Lato', 'Roboto', 'Montserrat', 'Source', 'Fira', 'Inter', 'Poppins'];
