...
class DecryptedText {
    constructor(element, options = {}) {
        ...
        this.sequential = (options.sequential || element.dataset.decryptSequential || 'true') === 'true';
        this.revealDirection = options.direction || element.dataset.decryptDirection || 'start';
        this.useOriginalCharsOnly = (options.originalChars || element.dataset.decryptOriginalChars || 'false') === 'true';
    ...
    getNextIndex() {
        ...
        switch (this.revealDirection) {
            ...
            case 'center': {
                ...
                const nextIndex = revealed.size % 2 === 0 
                    ? middle + offset 
                    : middle - offset - 1;
